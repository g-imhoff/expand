...
// Expand desktop renderer. cva-free: the menu-button variants use typed
// record maps plus the existing `cn` helper instead of
// class-variance-authority, which is not an installed dependency.
// Keyframe-based animation utilities from the upstream block are dropped for
// the same installed-deps-only reason; show/hide is instant.

...
export const nodeAppContextLayer = (() => {
  ...
  const nodeAppContext = Effect.fn("DesktopNodeAppContext.make")(function*(dataDir?: string) {
  ...
  const nodeAppContextFromArgs = Effect.fn("DesktopNodeAppContext.fromArgs")(function*() {

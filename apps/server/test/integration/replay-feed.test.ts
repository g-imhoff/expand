...
const TestLayer = Layer.mergeAll(ReplayFeedLayer, EventStoreLayer).pipe(Layer.provideMerge(TestSql))

const run = <A, E>(eff: Effect.Effect<A, E, ReplayFeed | EventStore | SqlClient>) =>

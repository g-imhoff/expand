...
export const nodeAppContextLayer = (() => {
  ...
  const nodeAppContext = Effect.fn("TuiNodeAppContext.make")(function*(dataDir?: string) {
  ...
  const nodeAppContextFromArgs = Effect.fn("TuiNodeAppContext.fromArgs")(function*() {

...
- **Owner:** `apps/cli/cli/contract/envelope.ts` defines `ENVELOPE_VERSION = "expand/v1"`.
...
- **Current value or rule:** The generator epoch is `1`; cached files include `g1` in their names.
